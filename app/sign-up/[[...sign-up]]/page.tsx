export default function SignUpPage() {
  const signUpUrl =
    'https://accounts.elyonnous.com/sign-up' +
    '?redirect_url=' +
  ...
  return (
    <div className="min-h-screen bg-[#0A0A0B] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <a
          href={signUpUrl}
          className="w-full flex items-center justify-center gap-3 rounded-xl py-3 px-4 font-semibold text-sm no-underline"
          style={{
            background: '#16161A',
        ...
        <div className="mt-6 pt-6 text-center" style={{ borderTop: '1px solid #2A2A30' }}>
          <p className="text-slate-500 text-sm">
            Já tem conta?{' '}
            <a href={signUpUrl.replace('sign-up', 'sign-in')} className="font-semibold" style={{ color: '#F0B429' }}>
              Entrar
            </a>
          </p>
        </div>
