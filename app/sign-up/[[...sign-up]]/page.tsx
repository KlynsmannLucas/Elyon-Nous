...
export default function SignUpPage() {
  const handleSignUp = () => {
    const redirect = encodeURIComponent('https://elyonnous.com/dashboard')
    window.location.href = `https://accounts.elyonnous.com/sign-up?redirect_url=${redirect}`
  }
    ...
    <div className="min-h-screen bg-[#0A0A0B] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 rounded-xl py-3 px-4 font-semibold text-sm transition-all hover:opacity-90 active:scale-95"
          style={{
            background: '#16161A',
