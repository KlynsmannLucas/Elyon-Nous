// app/sign-up/\[\[...sign-up\]\]/page.tsx — Sign up page (v2 light theme)
'use client'
        ...
        <div className="max-w-md text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {['Resultado em 2 minutos', '20+ setores', 'Estratégia com IA'].map((item) => (
              <span key={item} className="flex items-center gap-1.5 text-sm text-ink-2">
          ...
          <div className="bg-paper border border-line rounded-lg p-6">
            ...
            <div className="mt-6 pt-6 border-t border-line text-center">
              <p className="text-sm text-ink-2">
                Já tem conta?{' '}
                <a href="/sign-in" className="font-semibold text-blue hover:underline">
                  Entrar
                </a>
              </p>
            </div>
