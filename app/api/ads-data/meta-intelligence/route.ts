...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const [
      ...
      // 8 - insights de ads
      fetch(`${baseUrl}/${act}/insights?fields=${adInsightFields}&date_preset=last_30d&level=ad&limit=100&access_token=${token}`, { signal: AbortSignal.timeout(20000) }).then(r => r.json()),
