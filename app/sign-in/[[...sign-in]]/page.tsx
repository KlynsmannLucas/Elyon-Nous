        ...
        <div className="max-w-md text-center">
          ...
          <div className="mb-10">
            <svg width="56" height="56" viewBox="0 0 32 32" className="mx-auto mb-4">
              <defs><linearGradient id="lgsi" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#2B5BE3" /><stop offset="100%" stopColor="#0E9CB0" /></linearGradient></defs>
              <rect x="1" y="1" width="30" height="30" rx="9" fill="url(#lgsi)" />
