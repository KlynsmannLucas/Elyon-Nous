...
// ── Prompt builder ──────────────────────────────────────────────────────────
function buildCopywriterPrompt(input) {
    const { clientName, niche, product, offer, targetAudience, mainPain, mainDesire, objections, differentials, tone, platforms, frameworks, formats, variationsPerFramework, nicheDetails, strategyChannels, cpl_target, cta_preferences, } = input;
...
// ── Executor ────────────────────────────────────────────────────────────────
export async function runCopywriter(server, input) {
