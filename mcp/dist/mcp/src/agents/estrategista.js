...
// ── Prompt builder ──────────────────────────────────────────────────────────
function buildEstrategistaPrompt(input) {
    const { clientName, niche, products, budget, objective, monthlyRevenue, nicheDetails, city, currentCPL, currentLeadSource, mainChallenge, campaignHistory, ticketPrice, grossMargin, isRecurring, conversionRate, avgChurnMonthly, } = input;
...
// ── Executor ────────────────────────────────────────────────────────────────
export async function runEstrategista(server, input) {
...
//# sourceMappingURL=estrategista.js.map