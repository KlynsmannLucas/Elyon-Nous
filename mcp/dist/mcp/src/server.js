    ...
    try {
        ...
        switch (name) {
            ...
            case "elyon_data_analyst":
                result = await runDataAnalyst(server, DataAnalystInputSchema.parse(args));
                break;
            case "elyon_estrategista":
                result = await runEstrategista(server, EstrategistaInputSchema.parse(args));
                break;
            case "elyon_copywriter":
                result = await runCopywriter(server, CopywriterInputSchema.parse(args));
                break;
            case "elyon_report":
