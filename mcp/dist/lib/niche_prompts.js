...
export function getNicheConfig(nicheRaw) {
    if (!nicheRaw)
        return null;
    ...
    if (exactKey)
        return NICHE_CONFIGS.find((c) => c.key === exactKey) || null;
    // Match parcial
...
export function buildNichePromptContext(nicheRaw, nicheDetails) {
...
//# sourceMappingURL=niche_prompts.js.map