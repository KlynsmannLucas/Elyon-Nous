...
export function getBenchmark(nicheRaw) {
    if (!nicheRaw)
        return null;
 ...
 */
export function computeNicheProjection(bench, budget) {
    ...
    const budgetStatus = budget < bench.budget_floor ? 'abaixo' :
        budget < bench.budget_ideal ? 'mínimo' : 'ideal';
    const roasStatus = roasForComparison >= bench.kpi_thresholds.roas_good * 1.1 ? 'excelente' :
...
export function getBenchmarkSummary(nicheRaw) {
...
export { BENCHMARKS };
//# sourceMappingURL=niche_benchmarks.js.map